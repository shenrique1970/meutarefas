...
<body>
    <div="bloco_principal">
        ...
        <p><a href="tarefa.php">Voltar para a lista de tarefas</a></p>
        <p><strong>Concluída:</strong><?php echo $tarefa['concluida']; ?></p>
        ...
        <form method="post" enctype="multipart/form-data">
            <fieldset>
                <legend>Novo anexo</legend>
                    ...
                    <label>	<?php if ($tem_erros && array_key_exists('anexo',$erros_validacao)):?>
                    <span class="erro">
